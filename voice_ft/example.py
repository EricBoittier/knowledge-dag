...
# English-only tiny (smaller decoder vocab than multilingual whisper-tiny).
# For CLI entrypoints see voice_ft/scripts/train.py and voice_ft/scripts/transcribe.py.
...
_audio_url = "https://upload.wikimedia.org/wikipedia/commons/5/5b/Speech_12dB_s16.flac"
audio_file = "Speech_12dB_s16.flac"
if not os.path.isfile(audio_file):
    urllib.request.urlretrieve(_audio_url, audio_file)
